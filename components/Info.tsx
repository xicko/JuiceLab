...
const Info = () => {
  return (
    ...
    <div className="bg-white backdrop-blur-lg w-[1100px] rounded-[30px] overflow-hidden shadow-[0_0px_60px_-15px_rgba(0,0,0,0.3)] bg-opacity-35 my-20 md:mx-0 mx-6 flex md:flex-row flex-col justify-start items-center md:gap-x-12">
      ...
      <div className="max-w-[400px] w-fit mx-0 md:px-0 px-10 md:py-0 pb-12 pt-8">
        <p className="md:text-4xl text-3xl font-bold mb-4">
            Location & Hours
        </p>
        ...
        <div className='flex flex-row gap-x-3 mb-8'>
            <ul className='text-right w-[40px]'>
              <li>Mon:</li>
              <li>Tue:</li>
              <li>Wed:</li>
              <li>Thu:</li>
        ...
        <Link className='px-4 py-2 border-zinc-700 border-2 bg-zinc-700 hover:bg-zinc-100 rounded-md text-white hover:text-black ease duration-150 transition' href="https://maps.app.goo.gl/LLqNwNWiBK9oMbfd7" target="_blank">Open on Google Maps ↗</Link>
      </div>
    </div>
</div>
  )
